    ...
    <body class="min-h-screen my-64 bg-gray-100">
        ...
        <div class="text-center">
            <?php
                ...
                $inputFile = "../registers/hygeia_extracted_sept.pdf";
                $outputFile = "../outputs/hygeia_extracted_sept_2025.csv";
                ...
                echo "Hygeia Register has been converted <br> Click <a class='underline' href='../output/$outputFile'>Here</a> to download the file.";
                echo "</div>";
